...
" Put in /usr/share/vim/CURRENT VERSION FILE
if version < 600
  syntax clear
...
map <buffer> <F4>	:call RunRProgram()<CR><CR>
imap <buffer> <F4>	<ESC>:call RunRProgram()<CR><CR>
" map <F5> to get the output
map <buffer> <F5>	:e! /home/jinxs/.vim/vimSwap/ROutput<CR>:normal G<CR> 
imap <buffer> <F5>	<ESC>:e! /home/jinxs/.vim/vimSwap/ROutput<CR>:normal G<CR> 
